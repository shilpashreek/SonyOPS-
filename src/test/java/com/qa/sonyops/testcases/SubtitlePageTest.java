...
public class SubtitlePageTest extends BaseClass {
	...
	public void setup() throws Exception {
		...
		subtitlepagetest.initialisation(BaseClass.bc_url);
	...
	@Test(priority = 3, enabled = true, dependsOnMethods = { "ValidateSubtitleStatusFilter",
			"SubmitSubtitleStatusAndCaptureAlertMessage" })
	...
	public void ValiadteEssenceUpload() throws Exception {
		...
		Assert.assertTrue(EssenceUpload_successAlert.contains("Upload initiated successfully."),
				"Failed to allow aspera connect");
